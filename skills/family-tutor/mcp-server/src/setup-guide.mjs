  ...
  return [
    ...
    },
    {
      ...
      substeps:[
        ...
        { title:'Use Project-only memory', body:'In the kid Project, open Project settings → Memory and choose Project-only memory. This keeps the learner Project isolated from account-level memories and chats outside this Project.' },
        { title:'Open the learner profile template', html:`<p>Open the hosted learner profile template:</p><p><a class="button secondary" href="${esc(publicOrigin)}/setup/learner-profile-template.md" target="_blank" rel="noreferrer">Open learner profile template</a></p>` },
